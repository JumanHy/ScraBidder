...
const validationSchemaStep2 = Yup.object().shape({
  ...
  linkedIn: Yup.string().url("Invalid URL").required(),
});
  ...
  const handleSubmit = async (values) => {
    ...
    if (step === 3) {
      try {
        values = {
          ...values,
          address: { longitude: null, latitude: null, address: values.address },
        };
        const response = await axios.post(
          "http://localhost:5192/api/account/register/business",
          values
        );
                      ...
                      <Col xs={12} md={6}>
                        <Form.Group controlId="primaryContactFirstName">
                          ...
                          <Form.Control
                            ...
                            onChange={handleChange}
                            isInvalid={
                              touched.primaryContactFirstName &&
                      ...
                      <Col xs={12} md={6}>
                        <Form.Group controlId="primaryContactLastName">
                          ...
                          <Form.Control
                            ...
                            onChange={handleChange}
                            isInvalid={
                              touched.primaryContactLastName &&

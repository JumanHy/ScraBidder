      ...
      <div className="container pt-4 pb-5">
        <div className="row justify-content-center">
          ...
          <div className="col-12 col-sm-6 col-md-4 d-flex justify-content-center pb-3">
            ...
            >
              <ShieldLock
                className="me-2 thicker-icon mt-2"
                size={40}
                color="#003A70"
              />
              <h4 className="pt-3" style={{ color: "#003A70" }}>
                Trusted Platform
              </h4>
              <h6
                className="pt-3 text-center"
                style={{ color: "#333333", letterSpacing: 1 }}
              >
          ...
          <div className="col-12 col-sm-6 col-md-4 d-flex justify-content-center pb-3">
            ...
            >
              ...
              <h6
                ...
                style={{ color: "#333333", letterSpacing: 1 }}
              >
                Turns your recyclables into resources for a cleaner, healthier
                planet.
              </h6>
            </div>
          </div>

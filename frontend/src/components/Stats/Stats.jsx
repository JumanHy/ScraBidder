  ...
  return (
    ...
    <>
      <Container>
        ...
        <Row>
          <Col>
          <h2 className="text-center pt-3" style={{ color: "#003a70" }}>Revenue Over Time</h2>
          <div className="w-50 w-md-25 mx-auto">
            <span style={{ color: "#666666" }} className="me-2">Date Range</span>
            <Form.Control type="date" className="rounded-4" />
          </div>
          ...
          <Col>
          <div >
        <h2 className="text-center py-3" style={{color:'#003a70'}}>Auctions Over Categories</h2>
        ...
        <div className="shadow w-100 ms-5 mb-2" style={{ maxWidth: "500px" }}>
            <Chart
              chartType="PieChart"
              data={data}
              options={options}
